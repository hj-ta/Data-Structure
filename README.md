...
각 과제는 Queue, Binary Search Tree, B+ Tree, AVL Tree, Graph 등 주요 자료구조를 직접 구현하고, 이를 활용한 프로그램을 만드는 방식으로 진행되었다.

## Projects

| Assignment    | Project                  | Description                                            |
| ------------- | ------------------------ | ------------------------------------------------------ |
| Assignment 01 | Subtitle Manager         | Queue, Binary Search Tree, Linked List를 활용한 자막 관리 프로그램 |
| Assignment 02 | Flight Management System | B+ Tree, AVL Tree, Vector를 활용한 항공편 관리 프로그램             |
| Assignment 03 | Graph Algorithm Manager  | 인접 리스트, 인접 행렬 기반 그래프 알고리즘 프로그램                         |

## Assignment 01 - Subtitle Manager

자막 데이터를 관리하는 C++ 프로그램이다.
...
그래프 데이터를 기반으로 여러 그래프 알고리즘을 실행하는 C++ 프로그램이다.
